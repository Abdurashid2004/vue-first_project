<template>
  <div class="">
    <div class="navbar flex justify-between py-4 items-center">
      <div>
        <a href="#"><img src="../assets/logo1.png" alt="logo" /></a>
      </div>
      <div class="">
        <ul class="flex gap-8 cursor-pointer">
          <li class="font-bold"><a class="cool-link" href="#"></a>Home</li>
          <li><a class="cool-link" href="#"></a>Shop</li>
          <li><a class="cool-link" href="#"></a>Plant Care</li>
          <li><a class="cool-link" href="#"></a>Blogs</li>
        </ul>
      </div>
      <div class="flex gap-5 items-center">
        ...
        <div class="">
          <button
            ...
            class="px-6 py-2 bg-green-500 rounded-md flex gap-2 items-center text-white hover:bg-green-400"
          >
            <span
              ><svg
                width="20"
...
<style scoped>
.navbar {
  border-bottom: 1px solid rgb(129, 239, 129);
}
</style>
